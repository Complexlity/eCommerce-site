  ...
  return (
    <>
      ...
      <div
        className={
          divStyle +
          " cart absolute inset-0 h-full  w-[100%] max-w-[400px] bg-white opacity-[90%] dark:bg-gray-600 dark:text-gray-100 dark:opacity-[95%] xs:inset-auto xs:top-0 xs:right-0 xs:w-[80%] md:w-[60%]"
        }
      >
